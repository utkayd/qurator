...
| `service_busy` | 503 | Sign-in refused because the process-wide cap on concurrent password verifications is reached; nothing was checked, retry after `Retry-After` | `retry_after_s` |
